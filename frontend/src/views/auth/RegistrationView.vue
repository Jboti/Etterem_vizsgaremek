...
const validateUsername = (userName: string): boolean => {
    const userNameRegex = /^[A-Za-záÁéÉöÖőŐóÓüÜűŰúÚíÍ][A-Za-z0-9_áÁéÉöÖőŐóÓüÜűŰúÚíÍ\s]{5,18}$/ //min 6 hosszú, max 18 hosszú, ne kezdődjön számmal
...
const validatePassword = (password: string): boolean => {
    const passwordRegex = /^(?=.*[a-záéöőóüűúí])(?=.*[A-ZÁÉÖŐÓÜŰÚÍ])(?=.*\d)[a-zA-ZáÁéÉöÖőŐóÓüÜűŰúÚíÍ\d]{8,}$/ //min 8 hosszú, min 1 kis betű, min 1 nagy betű, min 1 szám
