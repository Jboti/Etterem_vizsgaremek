...
<template>
    ...
    <v-container class="pt-0 mt-0 d-flex justify-center align-center " style=" height: 75%; width: 90%; max-width: 1000px; min-width: 375px; min-height: 600px;">
        <v-card class="bg-red-darken-4" 
                ...
                border-radius: 10px;
                top: -10%;" outlined>
            <v-card-title style="text-align: center;" class="pb-6 pt-4"><h2 style="text-shadow: 2px 2px 2px black; color: whitesmoke; font-size: clamp(20px, 6vw, 50px);"><b>Bejelentkezés</b></h2></v-card-title>
            <v-card-text>
